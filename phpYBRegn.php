...
<button type='button' style='margin-top:250px;margin-left:35%; background-color:green; color:white;width:25%;height:15%;' onclick='loadHomePage()'> <h4>You are registered. Your page name is $fileName. Click Me to go Home Page to Login and Enjoy!</h4><a href='htmlYBHome.html'</button>";
